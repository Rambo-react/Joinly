...
const ProfileStatusWithHooks =(props) => {
    ...
    // useEffect выполняется после полной отрисовки, и потом если изменился статус в пропсах
        useEffect( () => {
        ...
        return (
            < div >
                {!editMode &&
                    <div>
                        <span onDoubleClick={activateEditMode}  >{props.status || "------HAVEN'T---STATUS-------"}</span>
                    </div>
                }
